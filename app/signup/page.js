  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-black px-4 py-10">
      ...
      <div className="relative w-full max-w-sm rounded-2xl border border-gray-700 bg-linear-to-br from-gray-900 to-gray-800 p-6 shadow-xl">
        ...
        <h1 className="mt-2 text-3xl font-black bg-linear-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">Sign up</h1>
        <p className="mt-1 text-sm text-gray-300">Create your account in a minute.</p>
        ...
        <p className="mt-4 text-sm text-gray-300">
          ...
          <Link href="/signin" className="font-medium text-purple-300 hover:text-purple-200 hover:underline">
            Sign in
          </Link>
        </p>
      </div>
